...
# define dd_memmove ft_memmove
# define dd_memchr ft_memchr
# define dd_strlen ft_strlen
# define dd_strchr ft_strchr
# define dd_strrchr ft_strrchr
# define dd_strncmp ft_strncmp
...
# define dd_strchr strchr
# define dd_strrchr strrchr
# define dd_strncmp strncmp
